 ...
 */
Ogre::SceneNode* TutorialApplication::createSceneNode(Ogre::String nodeName)
{
 ...
 */
Ogre::Entity* TutorialApplication::createEntity(Ogre::String entityName)
{
 ...
 */
Ogre::Light* TutorialApplication::createLight(Ogre::String lightName)
{
